...
export default function CreditBadge({
  ...
  return (
    <Link
      ...
      className="flex items-center gap-1.5 rounded-full border border-line bg-bg px-3 py-1.5 text-sm font-semibold text-primary transition hover:border-accent"
    >
